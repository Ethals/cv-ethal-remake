                                             ...
                                             <div class="row">
                                                  ...
                                                  <div class="col-xl-7 col-sm-7 col-12 mb-xl-0 mb-4">
                                                       <div class="form-group">
                                                            ...
                                                            <textarea class="ckeditor" id="ckedtor" type="text" name="deskripsi"></textarea>
                                                            <script>
...
<?php 
     if (isset($_POST['submit'])){
          ...
          $ext = pathinfo($filename, PATHINFO_EXTENSION);
               ...
               mysqli_query($conn, "INSERT INTO kegiatan VALUES(NULL,'$nama_kegiatan','$tanggal','$lokasi','$deskripsi','$xx')");
