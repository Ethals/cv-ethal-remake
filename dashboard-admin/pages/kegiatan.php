                                                       ...
                                                       ?>
                                                            <tr>
                                                                 ...
                                                                 <td class="align-middle text-center text-xs font-weight-bold mb-0" style="width: 80px;height: 60px;">
                                                                      <img src="../dist/img/kegiatan/<?php echo $data['foto'] ?>" alt="" style="object-fit: cover; width: 80px;height: 60px;">
                                                                 ...
                                                                 <td class="kolom-responsive" style="min-width: 20%;"><?php echo $data['nama_kegiatan']; ?></td>
                                                                 ...
                                                                 <td>
                                                                      <a href= "kegiatan_ubah.php?id=<?php echo $data['id']; ?>"><button class="bg-gradient-warning"><span class="button_top_table" style="border: 1px solid #ffc107">Ubah</span></button></a>
                                                                      <a onclick="return confirm('Anda Yakin Akan Mengahapus Data Ini ??')" href= "kegiatan_hapus.php?id=<?php echo $data['id']; ?>"><button class="bg-gradient-danger"><span class="button_top_table" style="border: 1px solid #dc3545">Hapus</span></button></a>
                                                                 </td>
                                                            </tr>
                                                       <?php } ?>
                                                  </tbody>
