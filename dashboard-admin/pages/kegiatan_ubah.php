                                             ...
                                             <div class="row">
                                                  <div class="col-xl-5 col-sm-5 col-12 mb-xl-0 mb-4">
                                                       <div class="form-control-new">
                                                            <input type="text" name="nama_kegiatan" value="<?php echo $load_driver['nama_kegiatan']?>" required="">
                                                            <label>
...
<?php
     if (isset($_POST['ubah'])){
          ...
          $ext = pathinfo($filename, PATHINFO_EXTENSION);
               ...
               $xx = $rand.'_'.$filename;
               move_uploaded_file($_FILES['foto']['tmp_name'], '../dist/img/kegiatan/'.$rand.'_'.$filename);
               mysqli_query($conn, "UPDATE kegiatan SET nama_kegiatan = '$nama_kegiatan', tanggal = '$tanggal', lokasi = '$lokasi', deskripsi = '$deskripsi', foto = '$xx' WHERE id = '$id'");
